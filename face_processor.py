...
STYLE_CONFIG = {
    "ghibli":     {"label": "Ghibli",      "subtitle": "Miyazaki · Watercolor",      "emoji": "🌿", "color": "#7bc96f"},
    "anime_op":   {"label": "Anime-OP",    "subtitle": "One Piece · Oda",            "emoji": "✨", "color": "#ff69b4"},
    "anime_db":   {"label": "Anime-DB",    "subtitle": "Dragon Ball · Toriyama",     "emoji": "🔥", "color": "#ff6b00"},
    "pixar":      {"label": "Pixar 3D",    "subtitle": "Animated · Disney",          "emoji": "🎬", "color": "#00b4d8"},
    "disney":     {"label": "Disney 2D",   "subtitle": "Renaissance · Classic",      "emoji": "👑", "color": "#ffd700"},
    "simpsons":   {"label": "Simpsons",    "subtitle": "Springfield · Yellow",       "emoji": "🟡", "color": "#ffd90f"},
    "southpark":  {"label": "South Park",  "subtitle": "Cutout · Comedy",            "emoji": "✂️", "color": "#e74c3c"},
    "gta":        {"label": "GTA",         "subtitle": "Loading Screen · Vice",      "emoji": "🔫", "color": "#ff8c00"},
    "minecraft":  {"label": "Minecraft",   "subtitle": "Voxel · Blocky",             "emoji": "⛏️", "color": "#27ae60"},
    "timburton":  {"label": "Tim Burton",  "subtitle": "Gothic · Whimsical",         "emoji": "🕸️", "color": "#5a3d7a"},
    "cyberpunk":  {"label": "Cyberpunk",   "subtitle": "Neon Noir · Chrome",         "emoji": "🤖", "color": "#ff00ff"},
    "claymation": {"label": "Claymation",  "subtitle": "Clay · Stop Motion",         "emoji": "🎨", "color": "#e67e22"},
    "comicbook":  {"label": "Comic Book",  "subtitle": "Ink · Halftone",             "emoji": "💥", "color": "#e74c3c"},
    "darksouls":  {"label": "Dark Souls",  "subtitle": "Medieval · Dark Fantasy",    "emoji": "⚔️", "color": "#4a4a4a"},
    "popart":     {"label": "Pop Art",     "subtitle": "Warhol · Halftone",          "emoji": "🌈", "color": "#ff4081"},
    "artdeco":    {"label": "Art Deco",    "subtitle": "Gatsby · 1920s Gold",        "emoji": "🏛️", "color": "#c8a24e"},
    "baroque":    {"label": "Baroque",     "subtitle": "Oil · Old Masters",          "emoji": "🖼️", "color": "#8b6914"},
    "synthwave":  {"label": "Synthwave",   "subtitle": "Neon · Retrowave",           "emoji": "🌅", "color": "#ff1493"},
}
STYLE_ORDER = [
